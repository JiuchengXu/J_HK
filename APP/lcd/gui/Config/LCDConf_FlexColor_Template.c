...
void LCD_X_Config(void) {
	GUI_DEVICE *dev = 	GUI_DEVICE_CreateAndLink(&GUIDRV_Template_API, GUICC_M565, 0, 0); //创建显示驱动器件
	//GUI_DEVICE *dev1 = 	GUI_DEVICE_CreateAndLink(&GUIDRV_Template_API, GUICC_M565, 0, 1); //创建显示驱动器件
	...
	LCD_SetVSizeEx   (1, VXSIZE_PHYS, VYSIZE_PHYS);
#endif	
	#if 0
